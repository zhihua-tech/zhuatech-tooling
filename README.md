...
![知华模具工装管理业务端工作台](docs/images/workbench.png)

业务端：模块导航、数量与业务指标、状态查询、详情及操作轨迹；按状态展示可用操作。

![知华模具工装管理管理端账号与权限](docs/images/admin.png)
...
![知华模具工装管理记录详情与审计](docs/images/record-detail.png)
...
- 后端：Java 21 / Spring Boot 4.0.7 / JDBC / Flyway / MySQL 8.4，包名 `cn.zhuatech.tooling`。
...
本方向按制造企业设备/工装常见管理流程选型；未取得可量化的免费产品覆盖率或搜索量数据。
